...
`},W=D("p",null,[F("Use "),D("code",null,"Rules"),F(" prop to validate the input.")],-1),xe=v({__name:"form-validation",setup(g){return(f,V)=>{const C=H,p=I,i=G,h=z;return w(),y(x,null,{default:o(()=>[l(a,{cols:"12"},{default:o(()=>[l(p,{title:"Simple Form Validation",code:J},{default:o(()=>[W,l(C)]),_:1},8,["code"])]),_:1}),l(a,{cols:"12"},{default:o(()=>[l(p,{title:"Validating Multiple Rules",code:K},{default:o(()=>[l(i)]),_:1},8,["code"])]),_:1}),l(a,{cols:"12"},{default:o(()=>[l(p,{title:"Validation Types",code:Q},{default:o(()=>[l(h)]),_:1},8,["code"])]),_:1})]),_:1})}}});export{xe as default};
